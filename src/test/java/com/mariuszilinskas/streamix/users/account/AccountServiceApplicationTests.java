package com.mariuszilinskas.streamix.users.account;

import com.mariuszilinskas.streamix.users.account.client.IdentityFeignClient;
import com.mariuszilinskas.streamix.users.account.config.FeignConfig;
import com.mariuszilinskas.streamix.users.account.config.RabbitMQConfig;
import com.mariuszilinskas.streamix.users.account.consumer.RabbitMQConsumer;
import com.mariuszilinskas.streamix.users.account.controller.UserAdminController;
import com.mariuszilinskas.streamix.users.account.controller.UserController;
...
import com.mariuszilinskas.streamix.users.account.service.UserAdminServiceImp;
import com.mariuszilinskas.streamix.users.account.service.UserServiceImpl;
